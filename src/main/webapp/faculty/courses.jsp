								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="./add-material?id=${c.id}" class="btn">Edit Project (material)</a>
										</div>
										...
										<div class="cours-more-info">
											...
											<div class="price">
												<button class="btn" onclick="window.location.href='courses-details?id=${c.id}'">Go to Project</button>
											</div>
										</div>
									</div>
								</div>
