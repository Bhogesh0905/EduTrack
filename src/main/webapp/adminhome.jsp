        ...
        ***********************************-->
        <div class="nav-header">
            <a href="adminhome" class="brand-logo">
                <img class="logo-abbr" src="./admin/images/logo-1.jpg" alt="" style="height: 80px; width: 100px; ">
            </a>
                ...
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./admin/all-professors">All Portfolios</a></li>
                            <li><a href="./admin/add-professor">Add Portfolios</a></li>
                            <li><a href="./admin/professor-issue">Portfolios Issue</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./admin/all-courses">All Projects</a></li>
                            <li><a href="./admin/add-course">Add Project</a></li>
                            <li><a href="./admin/StudentRegisteredCourses">Student Registered Project</a></li>
                            <li><a href="./admin/FacultyRegisteredCourses">Admin Registered Projects</a></li>
                        </ul>
                    </li>				
						...
						<div class="widget-stat card bg-warning">
							<div class="card-body">
								<div class="media">
									...
									<div class="media-body text-white">
										<p class="mb-1">Total Portfolios</p>
