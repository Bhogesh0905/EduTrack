                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <a href="FacultyRegisteredCourses"><h4>Faculty Registered Projects</h4></a>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="FacultyRegisteredCourses">Faculty Registered Projects</a></li>
                        </ol>
                    </div>
                </div>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Faculty Registered Projects List</h4>
									</div>
									<div class="card-body">
												...
												<div class="text-center">
													...
													<ul class="list-group mb-3 list-group-flush">
														<li class="list-group-item px-0 d-flex justify-content-between">
															<span class="mb-0">Project Code :</span><strong><c:out value="${c.code}" /></strong></li>
														<li class="list-group-item px-0 d-flex justify-content-between">
