...
<head>
    ...
    <title>EduTrack-Profile Page</title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="all-professors">All Portfolio</a></li>
                            <li><a href="add-professor">Add Portfolio</a></li>
                            <li><a href="professor-issue">Portfolio Issue</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="all-courses">All Projects</a></li>
                            <li><a href="add-course">Add Projects</a></li>
                            <li><a href="StudentRegisteredCourses">Student Registered Projects</a></li>
                            <li><a href="FacultyRegisteredCourses">Faculty Assigned Project</a></li>
                        </ul>
                    </li>				
